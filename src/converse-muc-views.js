...
import AddChatRoomModal from "./modals/add-muc.js";
import ListChatRoomsModal from "./modals/list-mucs.js";
        ...
        _converse.RoomsPanel = View.extend({
            ...
            showAddRoomModal (ev) {
                if (this.add_room_modal === undefined) {
                    this.add_room_modal = new AddChatRoomModal({'model': this.model});
                }
            ...
            showListRoomsModal(ev) {
                if (this.list_rooms_modal === undefined) {
                    this.list_rooms_modal = new ListChatRoomsModal({'model': this.model});
                }
